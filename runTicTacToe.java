...
public class runTicTacToe {
	...
	public static void main(String[] args) {		
        ...
        // Test AI win rate against AI
        /**
        for(int i = 0; i < 100; i++) {
            
            System.out.println("Running AI test #" + (i+1));
            ...
            else if (winner == -1) ties++;
            else System.out.println("Something wrong");
        }
        long end_time = System.currentTimeMillis();
        System.out.println("AI 1 win rate = " + player1Wins + "%");
        System.out.println("AI 2 win rate = " + player2Wins + "%");
        System.out.println("Ties = " + ties + "%");
        long time = ((end_time - start_time)/100)/1000;
